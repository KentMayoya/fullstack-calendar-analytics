 ...
 * query the Supabase database. JpaRepository&lt;User, UUID&gt; tells Spring
 * Boot that User's Id (annotated using @Id) is a UUID, which is compatible with
 * the User object defined in the entities package.
 */
